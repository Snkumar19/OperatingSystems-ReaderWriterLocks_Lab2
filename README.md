...
go to the csc501-lab2-qemu/compile directory and do “make clean”.
go to the directory of which your csc501-lab2-qemu directory is a subdirectory (NOTE: please do not rename csc501-lab2-qemu, or any of its subdirectories.) e.g., if /home/csc501/csc501-lab2-qemu is your directory structure, goto /homes/csc501
create a subdirectory TMP (under the directory csc501-lab2-qemu) and copy all the files you have modified/written, both .c files and .h files into the directory.
compress the csc501-lab2-qemu directory into a tgz file and submit your file on Moodle. Please only upload one tgz file.
tar czf csc501-lab2.tgz csc501-lab2-qemu
Also, please remember that you are allowed and encouraged to share test cases on Piazza.
